...
<title>Bootstrap 3 Викторина. Проверочные тесты. <?php include '../include/title.php'; ?></title>
<meta name='description' content='Bootstrap 3 Викторина. Проверочные тесты. Оценка знаний по Bootstrap 3. W3Schools на русском'>
...
<?php include '../include/before_content_quiztest.php'; ?>
  ...
  <article>
      <h1>Bootstrap 3 Викторина</h1>
      <div id="quizmain">
          <div id="quizcontainer">
              <script src="../scripts/quiztest.js"></script>
              <h3>Вопрос 1 из 25:</h3>
              <p id="qtext"><strong>Bootstrap 3 ориентирован на мобильные устройства.</strong></p>
              <form role="form" id="quizform" name="quizform" action='https://www.w3schools.com/quiztest/quiztest.asp?qtest=BOOTSTRAP' method='post'>
                  ...
                  <div style="position:relative;width:100%;">
                      <div id="altcontainer" class="notranslate">
                          <label class='radiocontainer' id='label2'> Ложь<input type='radio' name='quiz' id='2' onclick='clickRadio(this)' value='2' /><span class='checkmark'></span></label><label class='radiocontainer' id='label1'> Правда<input type='radio' name='quiz' id='1' onclick='clickRadio(this)' value='1' /><span class='checkmark'></span></label>
                      </div>
                  </div>
              ...
              <div class="w3-panel w3-note linktotutdiv">
                  <h4>Изучите Bootstrap 3 с помощью <a href="../bootstrap/index.php">Bootstrap 3 Учебника</a> на нашем сайте <strong>W3Schools на русском</strong></h4>
              </div>
          </div>
      </div>
