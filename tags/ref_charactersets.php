...
<title>HTML Наборы символов. Коды. Справочник. <?php include '../include/title.php'; ?></title>
<meta name='description' content='Наборы символов (кодировка) в HTML. Справочник. Какие существуют наборы символов и как их использовать на веб-страницах. Курс по основам HTML5. <?php include '../include/description.php'; ?>'>
...
<article>
  <h1>HTML <span class='color_h1'>Наборы символов</span></h1>
  <div class='w3-clear nextprev'>
    <a class='w3-left w3-btn' href='ref_av_dom.php'>&#10094; Prev</a>
    <a class='w3-right w3-btn' href='ref_html_dtd.php'>Next &#10095;</a>
  </div>
  <hr>
  <h2>Общие наборы символов HTML</h2>
  <p>ANSI был первым официальным набором символов в Windows.</p>
  <p>Стандартный набор символов в HTML 4 был 8859-1.</p>
  <p>Стандартный набор символов в HTML 5 - UTF-8.</p>

  <p>Для более детального ознакомления посетите <a href='../charsets/index.php'>Полный справочник наборов символов HTML</a> на нашем сайте <strong>W3Schools на русском</strong>.</p>
